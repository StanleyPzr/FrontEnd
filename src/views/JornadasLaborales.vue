  ...
  export default {
    ...
    methods: {
      async obtenerJornadas() {
        ...
        if (data && data.jornadasLaborales) {
          console.log('Jornadas laborales obtenidas:', data.jornadasLaborales);          
          this.jornadas = data.jornadasLaborales;
          this.totalJornadas = data.jornadasLaborales.length;
        }
      },
